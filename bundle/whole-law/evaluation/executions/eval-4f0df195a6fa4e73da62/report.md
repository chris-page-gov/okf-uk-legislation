...
Run `eval-4f0df195a6fa4e73da62` was executed at 2026-07-27T02:25:44Z against corpus
binding `248bc23de93a5a2991f320936c41cd4d872bfc37b0b1e30ee75a6be12a12ed5c`.
...
The named Claude journey passed 6 deterministic
local contracts with 1 failures. Its deployed
...
| `phase8-claude-local-contract-journey` | failed | 6 local Claude access contracts passed; 1 failed. |
...
- `claude_access_journey_ms`: 5.276 ms
- `executed_corpus_navigation_evaluation_ms`: 14098.720 ms
- `historical_baselines_ms`: 2.135 ms
- `legislation_suite_ms`: 73.853 ms
- `okf_explorer_workflow_ms`: 4.324 ms
- `verify_frozen_evidence_ms`: 0.001 ms
- `whole_law_suite_ms`: 54.067 ms
- `total_ms`: 14348.946 ms
