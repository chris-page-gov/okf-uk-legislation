...
Run `eval-f58a8fc7155f9ce36b2c` was executed at 2026-07-26T02:05:28Z against corpus
binding `ff922b874ff409ebe442ce4b8c1a46bf78f7cd438e220348bb90913af6ff04ec`.
...
- `answer_schema_contract_ms`: 0.079 ms
- `claude_access_journey_ms`: 0.583 ms
- `executed_corpus_navigation_evaluation_ms`: 15028.268 ms
- `historical_baselines_ms`: 2.193 ms
- `legislation_suite_ms`: 66.674 ms
- `okf_explorer_workflow_ms`: 4.345 ms
- `verify_frozen_evidence_ms`: 0.001 ms
- `whole_law_suite_ms`: 54.636 ms
- `total_ms`: 15266.688 ms
