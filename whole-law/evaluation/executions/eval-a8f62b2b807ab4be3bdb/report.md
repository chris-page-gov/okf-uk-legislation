...
Run `eval-a8f62b2b807ab4be3bdb` was executed at 2026-07-26T00:00:00Z against corpus
binding `e10abef20f7f5dfee0bf38f509393c70691ee27b06754e0366bd344f18654d3c`.
...
- Historical non-gold sources: 100 questions;
...
The local OKF/Explorer workflow passed 7/
...
| `phase8-deterministic-okf-explorer-workflow` | failed | 7/9 local descriptor, child, entrypoint and publication-mirror checks passed. |
...
- `answer_schema_contract_ms`: 0.072 ms
- `claude_access_journey_ms`: 0.589 ms
- `executed_corpus_navigation_evaluation_ms`: 3923.439 ms
- `historical_baselines_ms`: 0.556 ms
- `legislation_suite_ms`: 68.964 ms
- `okf_explorer_workflow_ms`: 4.088 ms
- `verify_frozen_evidence_ms`: 0.001 ms
- `whole_law_suite_ms`: 55.094 ms
- `total_ms`: 4159.125 ms
